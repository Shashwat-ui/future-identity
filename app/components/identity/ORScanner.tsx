    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-lg">
            <div className="relative p-8 rounded-3xl bg-linear-to-br from-cyan-900 via-cyan-700 to-cyan-400 shadow-2xl border-4 border-cyan-300 animate-futuristic-glow">
                ...
                <button onClick={onClose} className="absolute top-4 right-4 bg-cyan-400 text-white rounded-full px-4 py-2 shadow-lg hover:bg-cyan-600 transition">
                    Close
                </button>
                {error && <div className="text-red-400 mt-2">
                    {error}
                    </div>}
                    <style jsx>
                        {`
